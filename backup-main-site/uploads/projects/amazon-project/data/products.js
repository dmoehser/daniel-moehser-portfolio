// OOP class structure for products
class Product {
  constructor({ id, image, name, rating, priceCents, keywords, type }) {
    this.id = id;
    this.image = image;
    this.name = name;
    this.rating = rating;
...
class ClothingProduct extends Product {
  constructor(props) {
    super(props);
    this.sizeChartLink = props.sizeChartLink || 'images/clothing-size-chart.png';
  }
  getSizeChartLink() {
...
class Appliance extends Product {
  constructor(props) {
    super(props);
    this.instructionsLink = props.instructionsLink;
    this.warrantyLink = props.warrantyLink;
  }
}
...
export function loadProductsFetch() {
  return fetch('https://supersimplebackend.dev/products')
    ...
    .then((productsData) => {
      products = productsData.map(prod => {
        if (prod.type === 'clothing') {
          return new ClothingProduct(prod);
        } else if (prod.type === 'appliance') {
          return new Appliance(prod);
        } else {
    ...
    .catch((error) => {
      console.log('Error when loading the products:', error);
...
export { Product, ClothingProduct, Appliance };
